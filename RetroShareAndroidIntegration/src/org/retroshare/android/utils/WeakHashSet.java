/*
 * Copyright 2013 Gioacchino Mazzurco <gio@eigenlab.org>.
...
public class WeakHashSet<T> extends AbstractSet<T> implements Set<T>
{
	 ...
	 */
	private final Object getReferenceObject(WeakReference ref) { return (ref == null) ? null : ref.get(); }
	...
	{
		WeakElement wv = null;
		while ((wv = (WeakElement) this.queue.poll()) != null) { super.remove(wv); }
	}
	...
	static private class WeakElement extends WeakReference
	{
		...
		private static WeakElement create(Object o) { return (o == null) ? null : new WeakElement(o); }
		private static WeakElement create(Object o, ReferenceQueue q) { return (o == null) ? null : new WeakElement(o, q); }
